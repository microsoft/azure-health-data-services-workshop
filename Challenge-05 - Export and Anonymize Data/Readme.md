...
Perform a de-identified `$export` from the FHIR service to the "expsa" storage account as configured in the previous step. If you get stuck, refer to the documentation in Step 2. <br>
