...
+ FHIR data loaded into FHIR service.
  + For a more rich experience with this and future exercises, [load this bundle](./synthea_sample_data_fhir_r4%20OpenHack.zip) into the `zip` container in your FHIR Loader storage account.
