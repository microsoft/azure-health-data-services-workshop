...
When finished setting up the Azure role assignment for yourself and your Postman service client, you must generate an access token. Choose one of the paths bullets below to generate this token:
