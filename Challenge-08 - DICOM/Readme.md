...
You will need to add the **DICOM Data Owner** role for yourself (i.e., your username in Azure) as well as for the Postman service client application that you created in Challenge-01 ([documentation available here](https://docs.microsoft.com/en-us/azure/healthcare-apis/configure-azure-rbac#assign-roles-for-the-dicom-service)).
...
**Basic Path** You can use an already configured Postman collection to execute the tasks mentioned in the [beginning of the challenge](#learning-objectives-for-challenge-08).

Or

**Advanced Path** You can follow the provided articles for completing tasks using C#, Python, or cURL. 
