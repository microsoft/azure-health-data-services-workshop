...
2. Now you will create a new request in Postman for adding the `consent-resource.json` as a `Consent` Resource to your FHIR service. 
    ...
    - When ready, press `Send` to populate your FHIR service with the new `Consent` Resource. You should receive the Resource in the **Body** of the response and a `201 Created` code.
