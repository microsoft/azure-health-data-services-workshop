...
## Getting Started 
In this challenge, you will be setting up FHIR-Proxy as a FHIR gateway to perform Consent Opt-Out Filtering for the FHIR service. Essentially, you will be modifying authorization settings to control access to a patient's FHIR data. Additionally, you will be creating a new Postman environment to call the FHIR-Proxy endpoint.
