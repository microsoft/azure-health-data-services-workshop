...
## Getting Started 
In this challenge, you will be setting up FHIR-Proxy as a FHIR gateway to perform Consent Opt-Out Filtering for the FHIR service. This means you will be setting up an authorization configuration to control access to FHIR data. Additionally, you will be creating a new Postman environment to call the FHIR-Proxy endpoint.
