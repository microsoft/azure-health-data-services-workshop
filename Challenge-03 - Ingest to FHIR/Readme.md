...
## Getting Started
For this challenge, you will upload FHIR data for import into Azure API for FHIR. You will need to examine error logs for problems and determine what is preventing one of the FHIR bundles from being ingested.
