...
## Getting Started
For this challenge, you will upload FHIR data for import into Azure API for FHIR. For one of the FHIR bundles, you will need to examine error logs and determine what is preventing the data from being ingested.
