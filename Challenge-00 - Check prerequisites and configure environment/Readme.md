...
## Introduction 
In this preliminary challenge, you will be checking your Azure Subscription and other pieces of your environment to make sure that all prerequisites are met before deploying the Azure components for this workshop. Please make certain that everything is in place before proceeding to Challenge-01.
