...
Once the ARM template finishes with the initial deployment, additional steps are necessary to complete the authentication configuration for the FHIR-Proxy function app. 
