...
Once the ARM template finishes the initial deployment of resources, additional steps are necessary to complete the authentication configuration for the FHIR-Proxy function app. 
