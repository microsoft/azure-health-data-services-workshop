...
1. Using the FHIR Search collection in Postman, perform a Patient query using the following search result parameters: ```_summary=true```, `_summary=count`, ```_total=accurate```.  
