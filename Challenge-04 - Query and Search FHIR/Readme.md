...
## FHIR Search methods
When you do a search in FHIR, you need to set the scope of information that you wish to query. You can begin your search with any of these set as the starting point:
