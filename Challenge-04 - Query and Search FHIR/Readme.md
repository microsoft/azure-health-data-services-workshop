...
In connection with `reference` Elements, Resources also have `reference` search parameters, which narrow Resources returned by looking at any references to other Resources. 
