...
<ol type="A">
    <li>Resource-type level interaction for a set of Resource instances (returned as a `Bundle`)</li> 
    <li>A specified [Resource Compartment](https://www.hl7.org/fhir/compartmentdefinition.html)</li> 
