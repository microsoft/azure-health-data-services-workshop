...
In connection with `reference` Elements, Resources also have `reference` search parameters which allow querying for Resources by examining their references to other Resources. 
