...
> __*Note:__ In this challenge, at times we will use the term "Resource" to mean a Resource instance - without explicitly saying "Resource instance". This is the way "Resource" is used in the [FHIR literature](https://www.hl7.org/fhir/resourcelist.html) - to mean either "Resource type" or "Resource instance" - depending on context. 
