...
## FHIR Search methods
When you do a search in FHIR, you need to set the scope of information that you wish to query. You can begin by specifying any of these search domains as a starting point:
