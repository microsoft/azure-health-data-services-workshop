...
2. Now, perform a search using the custom search parameter that you just created. Try the `Search by Custom Search Parameter` call in the FHIR Search collection in Postman and see what results you get.
