...
If you want to retrieve the Resource instance for a specific patient, you could narrow your search by adding the `_id` search parameter and a known `id` value: 
