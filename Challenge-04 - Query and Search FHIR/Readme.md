...
In connection with `reference` Elements, Resources also have `reference` search parameters, which narrow Resources returned by inspecting their references to other Resources. 
