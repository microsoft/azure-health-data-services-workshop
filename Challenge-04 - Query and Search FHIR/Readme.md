...
In connection with `reference` Elements, FHIR Resources are defined with `reference` search parameters that allow querying Resources for references to other Resources.
