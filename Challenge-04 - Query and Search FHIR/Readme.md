...
The search parameter `_id` is used to query for a Resource instance by searching against its [Logical ID](https://www.hl7.org/fhir/resource.html#id) on a FHIR server. 
