...
3.	Copy and paste the HL7v2 message into the `Body` of the `Convert Data – HL7` request that you created in Postman*. Make sure to format the JSON request parameters as shown in the documentation.
