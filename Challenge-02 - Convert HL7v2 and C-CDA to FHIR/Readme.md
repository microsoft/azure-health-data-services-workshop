...
3.	Copy and paste the HL7v2 message into the `Body` of the `Convert Data – HL7` request that you created in Postman*. Format the JSON request parameters following the example in the documentation.
